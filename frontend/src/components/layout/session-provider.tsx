    ...
    <>
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden relative">
          <button type="button" onClick={() => setShowLogin(false)} aria-label="Cerrar"
          ...
          <div className="p-6 sm:p-8">
            ...
            <button type="button" onClick={() => { setShowLogin(false); router.push("/"); }}
              className="w-full flex items-center justify-center gap-2 mt-3 text-sm font-semibold text-gray-500 hover:text-purple-600 transition-colors">
